...
let points = [new Point(0, 0), new Point(10, 10), new Point(200, 200), new Point(2, 1), new Point(240, 1), new Point(-200, -200)]

let f_points =  [
  {
      "imag": 3.903127820947816e-17,
      "real": 8.014422459012849e-16
  },
  {
...
function App() {
  let [fourier, setFourier] = useState(new Fourier(f_points, 50, 1/5, 0.01));
  ...
  return (
    <div className="App">
      <ReadOnlyCanvas points={fourier.currentCanvasState()} width={500} height={500}/>
    </div>
  );
}
